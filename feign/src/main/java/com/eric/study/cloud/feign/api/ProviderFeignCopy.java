...
/**
 * Just validate each Feign client log
 */
@FeignClient(name = "provider-server2", configuration = ProviderFeignConfigCopy.class)
public interface ProviderFeignCopy {
